...
public class MyServiceImplTest {
	public static void main(String[] args) {
		...
		ApplicationContext factory = new FileSystemXmlApplicationContext("src/step05/msg.xml");
		...
		step04.MyServiceImpl ms = factory2.getBean("msg1", step04.MyServiceImpl.class);

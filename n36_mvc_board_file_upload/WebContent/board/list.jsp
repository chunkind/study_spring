	...
	<center>
	 ...
	 --%>
			<c:if test="${requestScope.lvo.pagingBean.previousPageGroup}">
				<a href="board.do?command=list&pageNo=${requestScope.lvo.pagingBean.startPageOfPageGroup-1}">
	 ...
	 --%>
			...
			<c:if test="${requestScope.lvo.pagingBean.nextPageGroup}">
				<a href="board.do?command=list&pageNo=${requestScope.lvo.pagingBean.endPageOfPageGroup+1}">

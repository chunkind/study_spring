...
public class SpringJdbcUserDaoImpl extends JdbcDaoSupport implements UserDao{
   ...
   public User getUser(String userId) throws Exception {
      ...
      return (User) getJdbcTemplate().queryForObject(messageSourceAccessor.getMessage("user.sql.select"), args, 
            new RowMapper(){
